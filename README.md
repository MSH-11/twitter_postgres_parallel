...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/MSH-11/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        8m43.607s          |        0m15.945s          | 
| `pg_normalized_batch`  |        3m12.430s          |        0m3.834s           | 
| `pg_denormalized`      |        0m22.846s          |        0m3.770s           | 
